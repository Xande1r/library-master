...
Book::Book(int nBookID, string strBookName, string classify, string strAuthor, string strISBN, string strPub, time_t inDate, int nTotalNum, int nLeftNum)
{
	m_nBookID = nBookID;
...
string Book::GetClassify()
{
	return m_classify;
}

void Book::SetClassify(string classify)
{
	m_classify = classify;
}
