...
public:
	Book();
	Book(int nBookID, string strBookName, string classify, string strAuthor, string strISBN, string strPub, time_t inDate, int nTotalNum, int nLeftNum);
	int GetBookID();
